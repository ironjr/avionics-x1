...
bit bmp280_i2c_init(bmp280 *bmp) {
    ...
    i2c1_readDataBlock(
            ...
            (char *)(&bmp->calib),
            24);
    return i2c1_getLastError() == I2C1_GOOD;
}

void bmp280_i2c_set_ctrl(bmp280 *bmp, uint8_t osrs_t, uint8_t osrs_p, uint8_t mode) {
...
void bmp280_i2c_set_conf(bmp280 *bmp, uint8_t t_sb, uint8_t filter) {
    uint8_t cfg;
...
void bmp280_i2c_set_osrs_t(bmp280 *bmp, uint8_t osrs_t) {
    uint8_t ctrl;
...
void bmp280_i2c_set_osrs_p(bmp280 *bmp, uint8_t osrs_p) {
    uint8_t ctrl;
    ctrl = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONTROL);
...
void bmp280_i2c_set_mode(bmp280 *bmp, uint8_t mode) {
    uint8_t ctrl;
    ctrl = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONTROL);
...
void bmp280_i2c_set_t_sb(bmp280 *bmp, uint8_t t_sb) {
    uint8_t cfg;
    cfg = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONFIG);
...
void bmp280_i2c_set_filter(bmp280 *bmp, uint8_t filter) {
    uint8_t cfg;
    cfg = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONFIG);
...
uint8_t bmp280_i2c_get_osrs_t(bmp280 *bmp) {
    uint8_t ctrl;
    ctrl = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONTROL);
    return (uint8_t)((ctrl & 0xE0) >> 5);
}

uint8_t bmp280_i2c_get_osrs_p(bmp280 *bmp) {
    uint8_t ctrl;
    ctrl = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONTROL);
    return (uint8_t)((ctrl & 0x1C) >> 2);
}

uint8_t bmp280_i2c_get_mode(bmp280 *bmp) {
    uint8_t ctrl;
    ctrl = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONTROL);
    return (uint8_t)(ctrl & 0x03);
}

uint8_t bmp280_i2c_get_t_sb(bmp280 *bmp) {
    uint8_t cfg;
    cfg = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONFIG);
    return (uint8_t)((cfg & 0xE0) >> 5);
}

uint8_t bmp280_i2c_get_filter(bmp280 *bmp) {
    uint8_t cfg;
    cfg = i2c1_read1ByteRegister(
            BMP280_I2C_ADDR | bmp->addr,
            BMP280_REG_CONFIG);
    return (uint8_t)((cfg & 0x1C) >> 2);
}

int32_t bmp280_i2c_read_temp_i32(bmp280 *bmp) {
...
int32_t bmp280_i2c_read_press_raw(bmp280 *bmp) {
    /* Request for the temperature register value. */
    /* Read from the consecutive registers. */
    uint8_t p_read[3];
    i2c1_readDataBlock(
 ...
 */
int32_t bmp280_i2c_read_press_i32(bmp280 *bmp) {
    int32_t adc_P = bmp280_i2c_read_press_raw();
